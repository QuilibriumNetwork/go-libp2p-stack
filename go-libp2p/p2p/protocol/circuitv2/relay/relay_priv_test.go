...
func TestMakeReservationWithP2PAddrs(t *testing.T) {
	...
	addrs := []ma.Multiaddr{
		tStringCast("/ip4/1.2.3.4/tcp/1234"),                         // No p2p part
		tStringCast("/ip4/1.2.3.4/tcp/1235/p2p/" + selfID.String()),  // Already has p2p part
		tStringCast("/ip4/1.2.3.4/tcp/1236/p2p/" + otherID.String()), // Some other peer (?? Not expected, but we could get anything in this func)
	}
